...
Now changing the test option to 'cross-validation' with a fold value of 10, gives an accuracy of 88%. While worse, it is still surprisingly accurate. after changing the seed to 2, it gives an accuracy of 90.5%. 
