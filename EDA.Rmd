...
```{r,  fig.cap="A dotplot showing the different carapace width and frontal lobe size between the blue and orange purple rock crab species."}
#clean up the data by removing unused data
CleanData <- CrabData[c(1,2,4,7)]

#Create a plot of the clean data
ggplot(CleanData, aes(y = CW, x = FL, color=sp)) +
  geom_point() +
  scale_x_continuous() +
  geom_jitter() +
  scale_color_manual(values=c("Blue","Orange")) +
...
N.A. Campbell and R.J. Mahon (1974),'A Multivariate Study of Variation in Two Species of Rock Crab of the Genus Leptograpsus', Awt. J. Zool (p.418).
