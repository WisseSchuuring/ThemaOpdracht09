...
```{r}
write.csv(CleanData, file = "data/CleanData.csv")
```
...
Upon testing, it is clear that the Simple Logistic classification method is the most suitable to identify the crab species and thus for creating the algorithm. 
