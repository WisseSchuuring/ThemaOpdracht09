...
these results showed that Simple Logistic works almost perfectly. Upon suggestion I have made a change to the cleaned data file, removing the unneccesairy gender value and opting for body depth instead, for it has a larger impact on deciding wether a creature belongs to one species or the other.
