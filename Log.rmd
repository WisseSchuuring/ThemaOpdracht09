...
day 9 Wednesday 13th October 2021

Utilizing cowplot, I managed to create a good overview of the relations between each attribute in the dataset, followed by only the two specific ones that I used in my algorithm. 

Reusing it again, I managed to get a nice overview of the gender differences. Added a plot that adds gender as a fourth dimension, revealing gender has no correlation with the species. 

Finally, I changed all the wrong names of Leptograspus variegatus.