...
Utilising cowplot, I managed to create a good overview of the relations between each attribute in the dataset, followed by only the two specific ones that I used in my algorithm. 
